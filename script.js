...
╚═╝     ╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝ ╚═════╝╚══════╝`;
    ...
    const welcome =
      ...
      this.wrapWithColor(
        '         Financial Modeling • Valuation • Capital Markets • Corporate Finance \n',
        '#666666',
      ) +
      this.wrapWithColor(divider + '\n\n', '#555555') +
...
${this.wrapWithColor('╰────────────────────────────────────────╯', '#ff8c00')}`;
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = 'princeingermany@gmail.com: ~/resume';
...
╚═╝     ╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝ ╚═════╝╚══════╝`;
    ...
    url.textContent = 'princeib.netlify.app';
